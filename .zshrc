...
plugins=(git asdf kubectl aliases zsh-autosuggestions you-should-use yarn pnpm npm zsh-syntax-highlighting)
...
source <(fzf --zsh)
source ~/.config/.zshrc_aliases
export PATH="$PATH:/Applications/WezTerm.app/Contents/MacOS"
export PATH="$PATH:/Applications/Brave\ Browser.app/Contents/MacOS"
